...
const Services = () => {
  ...
  return (
    <section className="w-full max-w-[1400px] mx-auto mt-[5rem] md:mt-[28rem] relative">
      ...
      {/* top image */}
      <div className=" absolute top-[-100px] md:top-[-200px] left-[12px] md:left-[260px] md:w-[800px] w-[400px]">
        <div className="w-full h-full relative">
          ...
          <div className=" w-full h-full text-[#FFFFFF] absolute top-0 left-0 bg-[#00000049] flex items-center justify-center flex-col text-center">
            <h2 className="font-[600] text-[25px] md:text-[40px]">
              Push your product to next level.
            </h2>
            <p className="text-[14px] md:text-[18px] font-[400] w-full md:w-[70%] md:mb-8 mb-4">
              End-to-end payments and financial management in a single solution.
              Meet the right platform to help realize.
            </p>
            <button className="md:py-3 md:px-10 px-8 py-2 rounded-full text-[16px] bg-brandColor text-[#fff]">
              Get Started
            </button>
          </div>
        </div>
      ...
      {/* heading text */}
      <div className=" absolute top-[150px] md:top-[250px] left-0 md:left-[300px] flex items-center flex-col md:w-[700px]">
        <h2 className="text-[25px] md:text-[40px] font-[600]">
      ...
      {/* cards */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 absolute top-[270px] md:top-[450px] left-0 px-6">
      ...
      <button className=" absolute bottom-[70px] left-[120px] md:left-[550px] mdL:py-3 md:px-10 py-2 px-8 rounded-md text-[16px] bg-brandColor text-[#fff]">
        More About Platform
      </button>
    </section>
  );
